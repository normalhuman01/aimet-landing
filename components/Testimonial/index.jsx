  ...
  return (
    <Div className="cs-testimonial cs-style1">
      ...
      <Div className="cs-rating">
        <Div className="cs-rating_bg" style={{backgroundImage: 'url(/images/home/estelar.svg)'}} />
        <Div className="cs-rating_percentage" style={{backgroundImage: 'url(/images/home/estelar.svg)', width:`${ratings * 20}%`}} />
      </Div>
